defmodule LibraryWeb.BookControllerTest do
  ...
  @plug_upload %Plug.Upload{path: "test/fixtures/test-cover.png", filename: "test-cover.png"}
  @create_attrs %{title: "some title", isbn: "some isbn", photo: @plug_upload}
  @update_attrs %{title: "some updated title", isbn: "some updated isbn", photo: @plug_upload}
  @invalid_attrs %{title: nil, isbn: nil, photo: nil}
